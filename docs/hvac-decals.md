...
[![Aged HVAC control decals](../images/hvac-decals/01-aged-hvac-decals-display.png)](../images/hvac-decals/01-aged-hvac-decals.png)
...
![Lifting an old HVAC decal with a pick](../images/hvac-decals/02-removing-old-decal.png)

Chrome trim rings should have four tits on them. Mine were all broken except one.

![Removed chrome trim ring](../images/hvac-decals/03-chrome-trim-ring.png)

Silver from the old decals left behind. I left it there since it will be hidden by the new decals.

![Silver decal backing left on the control panel](../images/hvac-decals/04-silver-backing-left-behind.png)

Destroyed the old decal during removal.

![Old decal damaged during removal](../images/hvac-decals/05-damaged-old-decal.jpg)

Pre-facelift cars don’t have chrome trim rings. Any notches in the decals will be visible, and ugly.

[![HVAC controls without chrome trim rings](../images/hvac-decals/06-controls-without-chrome-trim-rings-display.png)](../images/hvac-decals/06-controls-without-chrome-trim-rings.png)
...
![Decal notches visible without a chrome trim ring](../images/hvac-decals/07-exposed-decal-notches.png)

![Peeling the backing from a replacement decal](../images/hvac-decals/08-peeling-replacement-decal-backing.png)

I smeared a little rubber cement around the outside edge of my chrome rings, since all the tits were broken off.

![Chrome trim ring and rubber cement](../images/hvac-decals/09-rubber-cement-on-trim-rings.png)
