...
![Bushing / spacer for the 5-speed transmission](../images/convert-smt-transmission/01-five-speed-bushing.png)

6 Speed transmission with inverted freeze plug.

![6-speed transmission with the freeze plug inverted](../images/convert-smt-transmission/02-six-speed-inverted-freeze-plug.png)

5 Speed (and 6 speed?) transmission existing end bushing (rubber seal?) must be pulled out

![Existing end-bushing opening shown in the source](../images/convert-smt-transmission/03-existing-end-bushing.png)
